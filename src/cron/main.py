...
def catch_data(params):
    try:
        ...
        response = requests.get(
            'http://192.168.11.2:8000/playlists/',
            headers=params["headers"]).json()
        ...
        for point in box:
            ...
            response1 = requests.get(
                'http://192.168.11.2:8000/n_playlist_music1/',
    ...
    if params["dl_list"]:
        for i in params["dl_list"]:
            ...
            response2 = requests.post(
                'http://192.168.11.2:8000/d_playlist_music/',
            ...
            response3 = requests.delete(
                'http://192.168.11.2:8000/n_playlist_music/',
                params=d,
                headers=params["headers"])
